    ...
    for model_id in models_ids_list:
        ...
        if res != []:
            ...
            # Si Update : On supprime les anciennes données du modele 
                ...
                query = "DELETE FROM pieces_modeles WHERE model_id = %s" % model_id
                cursor.execute(query)  
                                ...
                                if not any((img['width'] > 527 or img['width'] == 14) for img in images_infos):
                                    if tables == None:
                                        ...
                                        for table in tables:
                                            ...
                                            # avec Valeurs '' pour meilleure lisibilité
                                            table.df[3] = ''
                                            # Si colonne 'Substitution' existe en col5 : copie en col6
                                            # Et valeurs '' si pas de valeur, pour meilleure lisibilité
                                            ...
                                            if 5 in table.df.columns:
                                                ...
                                                table.df[6] = ['' if value == '' else value for value in table.df[6]]
                                                table.df[5] = iPage+1  
                                            else:
                                                table.df[5] = iPage+1  
                                                table.df[6] = '' 
                        ...
                        for iPage, page in enumerate(pages_pdf):
                            ...
                            for table in tables:
                                ...
                                if len(table.df) > 4:
                                    ...
                                    table.df[3] = [value[13:] if 'Remplacé par' in value else '' for value in table.df[3]]
